...
FORMAT_RULES = (
    "Formatting: reply in short Markdown. Start with a one-sentence answer, then use bullet "
    "points or numbered steps. Use **bold** for key figures, dates, and terms. "
    "Do not use tables or HTML tags such as <br>."
)
...
Put that notice at the end as a single Markdown blockquote (one line starting with "> ").
{FORMAT_RULES}
Question: {state['question']}\n\nWeb evidence:\n{state['web_results']}
""").content
